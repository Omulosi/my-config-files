...
let g:NERDTreeIgnore = ['\.pyo$','^\.DS_Store$', '^tags$', '\.git$[[dir]]', '\.idea$[[dir]]', '\.sass-cache$', '\.pyc$', '\~$', '^node_modules$','__pycache__$[[dir]]', 'venv/', 'env/', '\.vim$[[dir]]']
nnoremap <A-h> <C-w>h
nnoremap <A-j> <C-w>j
nnoremap <A-k> <C-w>k
nnoremap <A-l> <C-w>l
...
" press Alt-p to search for file
nnoremap <A-p> :FZF<CR>
let g:fzf_action = {
  \ 'ctrl-t': 'tab split',
  \ 'ctrl-s': 'split',
...
" ignore files in .gitignore in search results
...
set mouse=a " scroll termninal with mouse

" set text wrap at 80 characters
